...
import 'package:nfts/animations/animations.dart';
import 'package:nfts/widgets/blur_container.dart';
...
class _InfoTile extends StatelessWidget {
  const _InfoTile({Key? key, required this.title, required this.subtitle}) : super(key: key);
