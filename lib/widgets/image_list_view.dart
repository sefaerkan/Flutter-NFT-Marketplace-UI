...
class _ImageListViewState extends State<ImageListView> {
  ...
  _autoScroll(){
    ...
    final _scroolEndPosition = _scrollController.position.maxScrollExtent;
    
    scheduleMicrotask(() {
      _scrollController.animateTo(_currentScrollPosition == _scroolEndPosition? 0 : _scroolEndPosition,
      ...
      child: SizedBox(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return _ImageTile(image: 'images/${widget.startIndex + index}.png');
          },
        ),
      ),
    );
